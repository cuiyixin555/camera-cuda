...
def detect_cuda_toolkit(repository_ctx):
    ...
    nvcc = "@camera_cuda//cuda/dummy:nvcc"
    nvlink = "@camera_cuda//cuda/dummy:nvlink"
    link_stub = "@camera_cuda//cuda/dummy:link.stub"
    bin2c = "@camera_cuda//cuda/dummy:bin2c"
    fatbinary = "@camera_cuda//cuda/dummy:fatbinary"
    if cuda_path != None:
